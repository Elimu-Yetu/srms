  ...
  <div class="authcard__body">
    ...
    <form method="post" style="margin-top:16px">
      ...
      <div class="field">
        ...
        <input id="email" name="email" type="email" value="<?= e(post('email')) ?>" required autofocus autocomplete="username">
      </div>
      <div class="field">
    ...
    <p class="tiny muted center" style="margin:14px 0 0">
      Forgot your password? Ask an administrator to reset it — no self-service reset, by design.
    </p>
  </div>
